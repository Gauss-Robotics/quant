...
namespace quant::geometry
{
    ...
    public:
         ...
         */
        T3TangentState() : _representation(0, 0, 0)
        {
            ;
        }
    ...
    protected:
         ...
         */
        T3TangentState(Vector const& xyz) : _representation(xyz.x, xyz.y, xyz.z)
        {
            ;
        }
         ...
         */
        T3TangentState(Eigen::Ref<Eigen::Vector3d const> vector) : _representation(vector)
        {
            ;
        }
