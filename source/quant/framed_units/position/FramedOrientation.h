...
namespace quant::framed_units::position
{
    ...
    class  Orientation : public Framed<units::position:: Orientation>
    {
    public:
        using Framed<units::position:: Orientation>::Framed;
    };

    inline std::ostream&
    operator<<(std::ostream& os, framed_units::position:: Orientation const& rhs)
    {
